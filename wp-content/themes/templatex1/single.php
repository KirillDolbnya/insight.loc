            ...
            <div class="bedroom__wrap">
                ...
                <div class="bedroom-right__block">
                    <div class="bedroom-block__image">
                        <img class="bedroom_image" src="<?= get_field('big_image')['url'] ?>"
                             alt="<?php the_field('subtitle'); ?>">
                    </div>
                </div>
            </div>
        </section>
                    ...
                    <?php } ?>
                        <div class="block-gallery__images">
                            ...
                            <?php } ?><?php if ($count == 2 or $count == 3) { ?>
                                <div class="asdasdasd">
                                    <img class="projectAdaptiv leftAdaptiv item_gallery_2"
                            ...
                            <div class="projectBottom"><?php } ?>
                                ...
                                <?php if ($count >= 4) { ?>
                                    ...
                                    <img class="projectAdaptiv item_gallery_3"
                                         src="<?php echo esc_url($image['sizes']['large']); ?>">
                                    </div><?php } ?>
